...
class RegisterSales(UserControl):
    def __init__(self, route):
        ...
        self.tf_unit_price = TextField(expand=1, label="Preço Unitário:", border='none', value="1.500,00", prefix_text="AOA", text_size=20, read_only=True)
        self.tf_total_price = TextField(expand=1, label="Valor Total:", border='none', value="3.000,00", prefix_text="AOA", text_size=20, read_only=True)
        ...
        self.tf_CPF = TextField(border="none", expand=4, label="NIF:", text_size=16, read_only=True)
        self.tf_date = TextField(border="none", expand=3, label="Data:", text_size=16, read_only=True)
        self.tf_total_sale = TextField(border="none", expand=3, label="Total:", text_size=16, prefix_text="AOA", read_only=True)
            ...
            rows=[
                DataRow(
                    cells=[
                        ...
                        DataCell(Text("02")),
                        DataCell(TextField(border="none", prefix_text="AOA", value="115,50", read_only=True)),
                        DataCell(TextField(border="none", prefix_text="AOA", value="100,00", read_only=True)),
                        DataCell(TextField(border="none", prefix_text="AOA", value="331,00", read_only=True)),
            ...
            self.dt_products_sold.rows.append(
                DataRow(
                    cells=[
                        ...
                        DataCell(TextField(border="none", prefix_text="AOA", value=Validator.format_to_currency(data[5]), read_only=True)),
                        DataCell(TextField(border="none", prefix_text="AOA", value=Validator.format_to_currency(data[6]), read_only=True)),
                        DataCell(TextField(border="none", prefix_text="AOA", value=Validator.format_to_currency(data[7]), read_only=True)),
