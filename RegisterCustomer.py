...
class RegisterCustomer(UserControl):
    def __init__(self, route):
        ...
        self.tf_CPF = TextField(label='NIF', expand=2, on_blur=self.check_cpf_cnpj, on_change=self.analyze_register_customer)
        ...
        self.text_total = Text('AOA 350,00', style=TextThemeStyle.TITLE_MEDIUM)
    ...
    def check_cpf_cnpj(self, e):
        ...
        self.tf_CPF.error_text = "NIF inválido!"
        self.update()
        self.route.page.update()
        return False
            ...
            self.dt_order_history.rows.append(
                DataRow(
                    cells=[
                        ...
                        DataCell(Text(f"AOA {Validator.format_to_currency(data[2])}")),
