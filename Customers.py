...
class Customers(UserControl):
    def __init__(self, route):
        ...
        self.text_total = Text('AOA 0,00', style=TextThemeStyle.TITLE_MEDIUM)
    ...
    def fill_in_side_card(self, customer_data, adresses):
        ...
        self.side_card_column.controls.append(Row(alignment="left", spacing=20, controls=[Text(value=f"ID: {customer_data[0]}"), Text(value=f"NIF: {customer_data[2]}"),]),)
