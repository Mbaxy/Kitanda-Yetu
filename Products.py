...
class Products(UserControl):
    def __init__(self, route):
        ...
        self.text_total = Text(value="AOA 0,00", style=TextThemeStyle.TITLE_MEDIUM)
            ...
            self.dt_products.rows.append(
                DataRow(
                    ...
                    cells=[
                        ...
                        DataCell(TextField(expand=True, value=f"AOA {data[4]}", border='none', read_only=True, text_align=TextAlign.END)),
    ...
    def fill_in_side_card(self, products_data):
        ...
        self.side_card_column.controls.append(Text(value=f"Custo: AOA {Validator.format_to_currency(float(products_data[8]))}"))
        self.side_card_column.controls.append(Text(value=f"Venda: AOA {Validator.format_to_currency(float(products_data[9]))}"))
