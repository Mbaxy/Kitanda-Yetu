...
class Sales(UserControl):
    def __init__(self, route):
        ...
        self.tf_CPF = TextField(border="none", expand=4, label="NIF:", value="92.791.243/0001-03", text_size=16, read_only=True, text_style=TextStyle(weight=FontWeight.BOLD))
        ...
        self.tf_total_sale = TextField(border="none", expand=3, label="Total:", value="1.000.000,00", text_size=16, prefix_text="AOA", read_only=True, text_style=TextStyle(weight=FontWeight.BOLD))
                        ...
                        content=Column(
                            ...
                            controls=[
                                ...
                                Row(
                                    ...
                                    controls=[
                                        Text(f"Data: {data[2]}"),
                                        Text(f"Total: AOA {Validator.format_to_currency(data[3])}"),
                                        Text(f"NIF: {data[5]}"),
                                    ]
                                ),
            ...
            self.dt_products_sold.rows.append(
                DataRow(
                    cells=[
                        ...
                        DataCell(TextField(border="none", prefix_text="AOA", value=Validator.format_to_currency(data[5]), read_only=True)), # unit price
                        DataCell(TextField(border="none", prefix_text="AOA", value=Validator.format_to_currency(data[6]), read_only=True)), # cost
                        DataCell(TextField(border="none", prefix_text="AOA", value=Validator.format_to_currency(data[7]), read_only=True)), # total
                    ]
                )
            )
