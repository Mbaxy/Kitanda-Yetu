...
class Home(UserControl):
    def __init__(self, route):
        ...
        self.line_chart = LineChart(
            ...
            top_axis=ChartAxis(
                title=Text("Evolução das Vendas (AOA)",style=TextThemeStyle.TITLE_MEDIUM),
                title_size=30,
                labels=[
                    ChartAxisLabel(
                        value=9,
        ...
        self.text_today_billing = Text(value="AOA 0,00", color=colors.GREEN, size=22)
    ...
    def update_sales_card(self, sales, billing):
        ...
        self.text_today_billing.value = "AOA 0,00" if billing is None else f"AOA {Validator.format_to_currency(billing)}"
        self.update()
